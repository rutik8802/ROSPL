...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><width="30px" height="30px"><strong>CovidCare</strong></a></li>
					<li><a href="locateus.php">Locate Us</a></li>
				
				
					<li><a href="/Covid-19 Website/razorpay/checkout.php">Payment</a></li> 
					<li><a href="/Covid-19 Website/index.php">Home</a></li>
				</ul>
			</div>
			<div class="center">
				<br>
				...
				<button onclick="document.getElementById('id01').style.display='block'" style="position:absolute;top:50%;left:45%">User Login</button>
				
			</div>	
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:white">
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" action="cover.php">
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Enter Username" style="text-transform: lowercase;" name="uname" required>
